...
def select_action(review: dict, active_group: str, control_state: dict,
                  ...
                  preset_mode: bool = False) -> Optional[str]:
    """
    ...
    if preset_mode:
        # 1. lighting (primary optimization dimension)
        if active_group == "lighting":
        ...
        if physics_diag == "minor_issue":
            physics_map = aspace.get("physics_issue_to_action", {})
            physics_actions = physics_map.get("minor_issue", [])
...
def apply_feedback(review_json_path: str, control_state_path: str,
                   ...
                   active_group_override: str = None) -> dict:
    """
