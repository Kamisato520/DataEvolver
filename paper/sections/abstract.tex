We present DataEvolver a fully automated pipeline for constructing training-ready synthetic datasets for image editing tasks.
...
DataEvolver addresses this by introducing a \emph{free-form VLM-guided rendering evolution loop}:
...
We instantiate this pipeline to construct \textbf{DataEvolver-Rotate},
...
Fine-tuning Qwen Image Edit 2511~\cite{PLACEHOLDER_qwen_image_edit_verify} with LoRA on DataEvolver-Rotate
