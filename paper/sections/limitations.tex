...
We discuss the current limitations of DataEvolver and directions for future improvement.
...
DataEvolver-Rotate contains 50 objects.
...
We validate DataEvolver on a single editing task (rotation).
