...
We propose \dataevolver{}, a pipeline in which rendering quality is improved through
...
We instantiate \dataevolver{} for a concrete and evaluable task:
...
We construct \textbf{DataEvolver-Rotate}, comprising 50 objects $\times$ 8 horizontal viewpoints,
...
LoRA fine-tuning of Qwen Image Edit 2511 on DataEvolver-Rotate improves over the base model
...
\begin{enumerate}
  ...
  \item \textbf{DataEvolver-Rotate dataset and validation.}
