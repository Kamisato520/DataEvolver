...
We presented DataEvolver, a pipeline for automatically constructing training-ready
...
We instantiated DataEvolver for rotation-conditioned image editing,
producing DataEvolver-Rotate: a 50-object, 350-pair dataset
...
LoRA fine-tuning of Qwen Image Edit 2511 on DataEvolver-Rotate
...
Second, applying DataEvolver to additional editing tasks---lighting variation,
