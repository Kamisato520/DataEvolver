\section{DataEvolver-Rotate Dataset}
\label{sec:dataset}

\subsection{Construction}
\label{sec:dataset:construction}

We apply the \aris{} pipeline to construct \textbf{DataEvolver-Rotate},
a dataset for rotation-conditioned image editing.
Each sample in DataEvolver-Rotate pairs a canonical front-view image of an object
...
\begin{figure}[t]
  ...
  \fbox{\parbox{0.95\linewidth}{\centering\vspace{3cm}
    ...
    \vspace{3cm}}}
  \caption{
    Sample images from DataEvolver-Rotate.
