...
def create_directories():
    """创建目标文件夹结构"""
    base_dir = "/huggingface/dataset_hub/ObjectMover-Benchmark/objectmoverA"
...
def organize_images():
    """整理图像文件"""
    source_dir = "/huggingface/dataset_hub/ObjectMover-Benchmark/ObjMove-A"
    target_dir = "/huggingface/dataset_hub/ObjectMover-Benchmark/objectmoverA"

    # 文件映射关系
    file_mapping = {
        "object.png": "object",
        "src_input.jpg": "images",
        "tar_input_512.png": "images_resize",
        "src_mask_hr.png": "source_mask",
        "src_box_mask.png": "source_mask_resize",
        "tar_box_mask.png": "target_bb",
        "src_bg.jpg": "background",
        "tar_input.jpg": "target_images",
    }

    # 获取所有real_*文件夹
    real_dirs = glob.glob(os.path.join(source_dir, "real_*"))
...
def main():
    ...
    # 检查源文件夹是否存在
    if not os.path.exists("/huggingface/dataset_hub/ObjectMover-Benchmark/ObjMove-A"):
        print("错误: ObjMove-A 文件夹不存在!")
        return
