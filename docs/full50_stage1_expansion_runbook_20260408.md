...
- [scene_obj021_050_objects.json](/D:/新建文件夹/用户目录/桌面/autoresearch_vlm/Auto-claude-code-research-in-sleep/ARIS/ARIS/configs/seed_concepts/scene_obj021_050_objects.json)
- [scene_full50_objects.json](/D:/新建文件夹/用户目录/桌面/autoresearch_vlm/Auto-claude-code-research-in-sleep/ARIS/ARIS/configs/seed_concepts/scene_full50_objects.json)
